...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/accounts/:id', name: 'account-detail', component: () => import('../views/AccountDetailView.vue') },
    { path: '/transactions', name: 'transactions', component: () => import('../views/TransactionsView.vue') },
    { path: '/transactions/new', name: 'post-transaction', component: () => import('../views/PostTransactionView.vue') },
