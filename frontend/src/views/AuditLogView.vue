      ...
      <div class="tablecard">
        <table>
          ...
          <tr v-for="e in filtered" :key="e.id">
            ...
            <td class="mono">
              <RouterLink v-if="e.entityType === 'TRANSACTION'" :to="`/transactions/${e.entityId}`">TXN-{{ e.entityId }}</RouterLink>
              <RouterLink v-else-if="e.entityType === 'ACCOUNT'" :to="`/accounts/${e.entityId}`">Account #{{ e.entityId }}</RouterLink>
